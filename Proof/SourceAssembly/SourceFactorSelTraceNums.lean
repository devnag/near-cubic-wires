...
namespace NearCubicWires.SourceFactorSel.TraceNumsGF
...
local notation "vdI" => clauseVals mask selector packets rows compiler sources p den hden k r scratch n x bits hp site code ph ci L lay deg V dflt
  ...
  (oldAt coordC ph ci sources L tgtC modeC 𝒷 (InitRun.D0 𝒷)) H A Rc familyCost refillCost firstCost counterReserve

end clause

end
end NearCubicWires.SourceFactorSel.TraceNumsGF
end
