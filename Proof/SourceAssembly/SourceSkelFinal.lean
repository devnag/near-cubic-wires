...
theorem sourceFinalAt (selector : PCJ9eff70d512234a4c_Fixed.CyclicChoice.Laws)
    (compiler : PCJ9eff70d512234a4c_Fixed.Packets.CompilerLaws) (xtra : XtraW selector)
    (steps : StepsHoleV5 selector compiler xtra
      (g7OfW selector xtra (NearCubicWires.SourceFactorSel.G7W.G7Site selector xtra))
      (firstW selector xtra (NearCubicWires.SourceFactorSel.G7W.G7Site selector xtra))) :
    SourceGenHoles3 selector compiler :=
  fill_V5G selector compiler xtra (NearCubicWires.SourceFactorSel.G7W.G7Site selector xtra) steps
