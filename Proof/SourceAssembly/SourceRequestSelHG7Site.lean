import Proof.SourceAssembly.SourceRequestSelHG7
...
open NearCubicWires.RepairOrdinary.CloseoutRowsOriginalClause (index negative)
open NearCubicWires.RepairRepresentation (PCPPRequest PointwisePCPPAlgorithm pcppOutput)
namespace NearCubicWires.SourceRequest.SelHG7Site
...
theorem hres48Site : 48 + restPc (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).se.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).sp.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW ≤ (𝔡).res := by
  have h := hresSite selector xtra mask packets rows sources gamma hg hh p
  omega

theorem hGW : NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p ≤ (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW := by
  show NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p ≤ NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p + NearCubicWires.SourceSkeleton.Params.gwWS mask sources gamma hg hh p
  exact Nat.le_add_right _ _

/-- The dock's `hN` (THR). -/
theorem hNSite : SelFront.NF + (19 + 4 * SelLocal.tT (decompositionOf sources)) ≤ (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW :=
  (SelLocal.hG_thr sources gamma hg hh p).trans (hGW selector mask packets rows sources gamma hg hh p)

/-- The dock's `hN` (SYM). -/
theorem hNSiteS : SelFront.NF + (19 + 4 * SelLocal.tS) ≤ (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW :=
  (SelLocal.hG_sym sources gamma hg hh p).trans (hGW selector mask packets rows sources gamma hg hh p)

theorem hroomSite (kb : Nat) (hkb : kb ≤ 512) :
    NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p + gwW mask.work (Cold.tapes (decompositionOf sources)) kb ≤ (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW := by
  have h := NearCubicWires.SourceSkeleton.Params.gwW_le_gwWS mask sources gamma hg hh p kb hkb
  show NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p + gwW mask.work (Cold.tapes (decompositionOf sources)) kb ≤
...
/-- **The dock's six distinctness facts at the v5 site** (`SelLocal.distinct_of_body` at `cacheSite`/`terminalSite`). -/
theorem distinctSite (V : Nat) (hV : (𝔡).U ≤ V) (mode : Bool) :
    Function.Injective (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV mode) ∧ (∀ j, (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV mode j).val < (𝔡).F) ∧
      (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV).val < (𝔡).F ∧ (∀ j, (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV mode j).val ≠ 1) ∧
      (∀ j, NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV mode j ≠ NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) ∧
      (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV).val ≠ 1 := by
  have hF := (NearCubicWires.SourceSkeleton.KeptW.site_nums selector xtra mask packets rows sources gamma hg hh p).1
  exact SelLocal.distinct_of_body sources p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p)
    (NearCubicWires.SourceSkeleton.FirstW.scrSite selector mask packets rows sources gamma hg hh p) mode (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV mode)
    (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (NearCubicWires.SourceSkeleton.FirstW.cacheSite_val selector xtra mask packets rows sources gamma hg hh p V hV mode) rfl (le_of_eq hF.symm)

theorem hG7_site_thr {V : Nat} (hV : (𝔡).U ≤ V)
    ...
    (hKc : ∀ j, K ((NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV false) j) ∧ K0 ((NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV false) j) = PCPPQueryIndexPadding.clauseData (pcppOutput rq (a.output rq)) rq.arity ci.val
      (PCPPQueryCachedBounds.capacity a (rq.circuit.size + rq.arity)) pw j ∧ KH0 ((NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV false) j) = 0)
    ...
    (hwin : ∀ m, m ≤ (monomials coordinate ph ci).length →
      Item4.g7Cost (fun m => SelLocal.selThrCost a rq ci coordinate bits ph L target cwid cw D b m) (fun m => Words.wordsCost mask SB (requestAt coordinate ph ci L target false m) MB) (SelBack.PT (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) coordinate ph ci
        L target m + 1 ≤ Rc) :
    ResidentRunH
      (Item4.g7Machine (RecoveryFocus.machine (SelLocal.gS (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (decompositionOf sources) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV false) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSite selector mask packets rows sources gamma hg hh p)) (SelLocal.selThrM ph (decompositionOf sources))) (SelBack.PT (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) (fun x => SelLocal.gS (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (decompositionOf sources) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV false) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSite selector mask packets rows sources gamma hg hh p) (SelBack.rgP (SelBack.PT (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) x)) (wordsHostM (layS mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p)) SB (srcOf (SelBack.PT (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) (fun x => SelLocal.gS (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (decompositionOf sources) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV false) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSite selector mask packets rows sources gamma hg hh p) (SelBack.rgP (SelBack.PT (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) x)))
        ((layS mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p)).hostV_lt _
          (layS_hN mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p) kb (hroomSite selector mask packets rows sources gamma hg hh p kb hkb))
          (layS_hVB mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p) (hres48Site selector xtra mask packets rows sources gamma hg hh p)))))
      (Item4.g7Cost (fun m => SelLocal.selThrCost a rq ci coordinate bits ph L target cwid cw D b m) (fun m => Words.wordsCost mask SB (requestAt coordinate ph ci L target false m) MB) (SelBack.PT (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) coordinate ph ci
        L target)
      ...
      (Dims.lenTape (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p).ext2.ext1.ext hV) coordinate ph ci L target false Rc b
  ...
  have dd := distinctSite selector xtra mask packets rows sources gamma hg hh p V hV false
  exact SelHG7.hG7_thr mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p
    (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p)
    (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV false) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSite selector mask packets rows sources gamma hg hh p) (SelLocal.hG_thr sources gamma hg hh p) SB hIn (hroomSite selector mask packets rows sources gamma hg hh p kb hkb) (hres48Site selector xtra mask packets rows sources gamma hg hh p) a rq coordinate ph ci L target Rc b qCap layoutAt capsAt MB dR K K0 KH0 Pw W Ld bits hread cwid cw D c QK pw hKc hKw hKr hKD hKt hKb dd.1 dd.2.1 dd.2.2.1 dd.2.2.2.1 dd.2.2.2.2.1 dd.2.2.2.2.2 hc hwinA hQR hiL hiR hcL hcR hbig hcwid h2cw hwinR hqD hPD hWD hLD hDR hDC hHfit hcw1 hcoef Vb hV4 hcoefV hbigR hcapT hRc1 hKq hKres hKrw hMB hdR hNw hS hT cq ck cm ci' hneed cl1 cl2 hwin

theorem hG7_site_sym {V : Nat} (hV : (𝔡).U ≤ V)
    {kb : Nat} (SB : Item4.StartBank (decompositionOf sources) kb) (hIn : ∀ j, (SB.inPort j).val = j.val)
    (hkb : kb ≤ 512)
    (a : PointwisePCPPAlgorithm) (rq : PCPPRequest a.minimumArity)
    (coordinate : Fin ((a.output rq).systematicBits + (a.output rq).auxiliaryBits) →
    ...
    (cwid cw D c QK : Nat) (pw : List Bool)
    (hKc : ∀ j, K ((NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV true) j) ∧ K0 ((NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV true) j) = PCPPQueryIndexPadding.clauseData (pcppOutput rq (a.output rq)) rq.arity ci.val
      (PCPPQueryCachedBounds.capacity a (rq.circuit.size + rq.arity)) pw j ∧ KH0 ((NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV true) j) = 0)
    (hKw : ∀ x : Fin V, x.val = 1 → K x ∧ K0 x = RepairOrdinary.frame bits ∧ KH0 x = 0)
    (hKr : ∀ i, i < 10 → ∀ x : Fin V, x.val = (𝔇).B + 29 + restPc (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).se.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).sp.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW + i →
    ...
    (hwin : ∀ m, m ≤ (monomials coordinate ph ci).length →
      Item4.g7Cost (fun m => SelLocal.selSymCost a rq ci coordinate bits ph L target cwid cw D b m) (fun m => Words.wordsCost mask SB (requestAt coordinate ph ci L target true m) MB) (SelBackSym.PS (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) coordinate ph ci
        L target m + 1 ≤ Rc) :
    ResidentRunH
      (Item4.g7Machine (RecoveryFocus.machine (SelLocal.gSS (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (decompositionOf sources) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV true) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSiteS selector mask packets rows sources gamma hg hh p)) (SelLocal.selSymM ph)) (SelBackSym.PS (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) (fun x => SelLocal.gSS (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (decompositionOf sources) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV true) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSiteS selector mask packets rows sources gamma hg hh p) (SelBack.rgP (SelBackSym.PS (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) x)) (wordsHostM (layS mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p)) SB (srcOf (SelBackSym.PS (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) (fun x => SelLocal.gSS (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (decompositionOf sources) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV true) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSiteS selector mask packets rows sources gamma hg hh p) (SelBack.rgP (SelBackSym.PS (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) x)))
        ((layS mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p)).hostV_lt _
          (layS_hN mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p) kb (hroomSite selector mask packets rows sources gamma hg hh p kb hkb))
          (layS_hVB mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p) (hres48Site selector xtra mask packets rows sources gamma hg hh p)))))
      (Item4.g7Cost (fun m => SelLocal.selSymCost a rq ci coordinate bits ph L target cwid cw D b m) (fun m => Words.wordsCost mask SB (requestAt coordinate ph ci L target true m) MB) (SelBackSym.PS (pcpp := a.output rq) (decompositionOf sources) Pw W Ld) coordinate ph ci
      ...
      ((𝔇).familySlots hV) ((𝔇).poolSlots hV) (Dims.rewind2Slots (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p).ext2.ext1.ext hV)
      ((𝔇).scr hV 5) ((𝔇).scr hV 6) ((𝔇).scr hV 7) ((𝔇).scr hV 8) ((𝔇).scr hV 9) ((𝔇).scr hV 10)
      (Dims.lenTape (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p).ext2.ext1.ext hV) coordinate ph ci L target true Rc b
      ((𝔇).pcT (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p).ext2.ext1 hV ⟨70, by unfold restPc; omega⟩)
      (fun i => (𝔇).pcT (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p).ext2.ext1 hV ⟨61 + i.val, by have := i.isLt; unfold restPc; omega⟩) layoutAt capsAt
      (Dims.Rpad (d := 𝔇) (eX := (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).se.extra) (pX := (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).sp.extra) (gW := (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW) (V := V) Rc)
      (RestIn4 (𝔇) (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).se.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).sp.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW Rc ((𝔇).pcT (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p).ext2.ext1 hV ⟨64, by unfold restPc; omega⟩) K K0 KH0)
      (fun x => OutV (𝔇) (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).se.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).sp.extra (NearCubicWires.SourceSkeleton.FirstW.DSite selector mask packets rows sources gamma hg hh p).gW x.val)  := by
  have dd := distinctSite selector xtra mask packets rows sources gamma hg hh p V hV true
  exact SelHG7.hG7_sym mask packets rows sources (NearCubicWires.SourceSkeleton.FirstW.resSite selector mask packets rows sources gamma hg hh p) p
    (NearCubicWires.SourceSkeleton.FirstW.kSite selector xtra mask packets rows sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.rSite selector xtra mask packets rows sources gamma hg hh p)
    (NearCubicWires.SourceSkeleton.FirstW.eSite selector xtra mask packets rows sources gamma hg hh p) hV (NearCubicWires.SourceSkeleton.Params.gG7 sources gamma hg hh p) (NearCubicWires.SourceSkeleton.FirstW.cacheSite selector xtra mask packets rows sources gamma hg hh p V hV true) (NearCubicWires.SourceSkeleton.FirstW.terminalSite selector xtra mask packets rows sources gamma hg hh p V hV) (hresSite selector xtra mask packets rows sources gamma hg hh p) (hNSiteS selector mask packets rows sources gamma hg hh p) (SelLocal.hG_sym sources gamma hg hh p) SB hIn (hroomSite selector mask packets rows sources gamma hg hh p kb hkb) (hres48Site selector xtra mask packets rows sources gamma hg hh p) a rq coordinate ph ci L target Rc b qCap layoutAt capsAt MB dR K K0 KH0 Pw W Ld bits hread cwid cw D c QK pw hKc hKw hKr hKD hKt hKb dd.1 dd.2.1 dd.2.2.1 dd.2.2.2.1 dd.2.2.2.2.1 dd.2.2.2.2.2 hc hwinA hQR hiL hiR hcL hcR hbig hcwid h2cw hwinR hqD hPD hWD hLD hDR hDC hHfit hcw1 hcoef Vb hV4 hcoefV hbigR hcapS hRc1 hKq hKres hKrw hMB hdR hNw hS hT cq ck cm ci' hneed cl1 cl2 hwin

end site

end
end NearCubicWires.SourceRequest.SelHG7Site
end
