...
/-! Frame an exact raw word using its physically present unary length.
The source and length driver are retained, and all four heads are reset. -/
namespace NearCubicWires.RepairSource.ProjectionNormalization.RawFrame
...
end NearCubicWires.RepairSource.ProjectionNormalization.RawFrame
