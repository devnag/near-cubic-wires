...
/-! Exact lookup meaning of the executed dense atom table. The descending
source order changes no code: entries are addressed by the supplied coding function. -/
