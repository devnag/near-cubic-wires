...
/-! The original incidence machine with a retained false prefix on its
physically produced row counter. The machine is unchanged; this strengthens
its configuration invariant to the normalizer's ready counter encoding. -/
set_option autoImplicit false
set_option maxHeartbeats 1000000
set_option maxRecDepth 120000
set_option warningAsError true
namespace PCJ9eff70d512234a4c_Fixed.Materializer.NativeMaskCount
open NearCubicWires NearCubicWires.ExtIncidence
open NearCubicWires.LocalBitMultitape NearCubicWires.RepairOrdinary
open NearCubicWires.RepairOrdinary.RecoveryExecution
abbrev machine := ExtIncidence.machine

def cfg (q : Fin 7) (input : List Bool) (ih B th : ℕ) (scratch : List Bool) (sh : ℕ)
    (out : List Bool) (count : ℕ) : Configuration 5 7 :=
  ⟨q, ![ih, th, sh, out.length, count+1],
    ![input, UnaryTemplate.tape B, scratch, out, false :: List.replicate count true]⟩
...
theorem start_row (input : List Bool) (ih B th : ℕ) (L : List Bool) (sh : ℕ) (out : List Bool) (c : ℕ)
  ...
  simp [step, machine, ExtIncidence.machine, cfg, Configuration.scanned, h]
...
theorem return_step (input : List Bool) (ih B k : ℕ) (hk : k < B) (L : List Bool) (out : List Bool) (c : ℕ) :
  ...
  simp [step, machine, ExtIncidence.machine, cfg, Configuration.scanned, UnaryTemplate.tape_mark B k hk]
  apply configuration_ext
  · rfl
  · funext i; fin_cases i <;> simp [applyAction, HeadMove.apply]
  · rfl
...
theorem return_done (input : List Bool) (ih B : ℕ) (L : List Bool) (sh : ℕ) (out : List Bool) (c : ℕ) :
  ...
  simp [step, machine, ExtIncidence.machine, cfg, Configuration.scanned]
  apply configuration_ext
  · rfl
  · funext i; fin_cases i <;> simp [applyAction, HeadMove.apply]
  · rfl
...
theorem counter_write (c : Nat) :
    writeTapeBit (false :: List.replicate c true) (c+1) true =
      false :: List.replicate (c+1) true := by
  have h := Streaming.write_append (false :: List.replicate c true) true
  simpa [List.replicate_add, List.cons_append] using h
...
theorem zero_done (input : List Bool) (ih B : ℕ) (L : List Bool) (sh : ℕ) (out : List Bool) (c : ℕ) :
  ...
  · rfl
  · funext i; fin_cases i <;> simp [applyAction, HeadMove.apply]
  · funext i; fin_cases i <;> simp [applyAction, counter_write]
...
end PCJ9eff70d512234a4c_Fixed.Materializer.NativeMaskCount
